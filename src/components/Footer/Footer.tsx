          ...
          <div className="myFooter-column BorderRight">
            <div className="discriptionBlock">
              <div className="footerLogodiv">
                <img src={Quizlogo} className="img-fluid FooterLogo" alt="" />
                <div className="fs-3 text-white bolderText">Quiz Game</div>
              </div>
              <div className="widget1">
                <p>
                  <b>Question Quiz :</b> A dynamic and engaging quiz game
                  designed to challenge and entertain users with a diverse range
                  of thought-provoking questions. Explore your knowledge,
                  compete with friends, and enjoy the thrill of learning in a
                  fun and interactive way. Developed with passion by Meet
                  Panchal – 2024.
                </p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              <p>Copyright &copy; 2024 Meet Panchal. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
